...
Opp:  O1/O2/O3    ← 大/中/小机会
Cert: C1/C2/C3    ← 高/中/低确定性
```
...
1. **风控扫描强制** — 推荐前必须 `python3 scripts/check_risk.py --code XXX`，R3 禁止推荐
...
**综合评级**：Risk: R[N] | Opp: O[N] | Cert: C[N] | Comfort: ⭐
